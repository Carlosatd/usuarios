...
<body>
<input type="hidden" name="error" id="error" class="hidden">
...
<div class="jumbotron">
    <div class="container">
        ...
        <p>Entre com seus dados e acesse nossa área de membros ou se cadastre</p>
            ...
            <h4><?php if(isset($_GET['error'])){
                    switch ($_GET['error']){
                        ...
                        case 'error':
                            ...
                            break;
                        case 'email':
                            echo 'Favor digitar email valido';
                            break;
                        case 'autError':
